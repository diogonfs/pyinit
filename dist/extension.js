...
const fileManager = __webpack_require__(/*! ./fileManager */ "./src/fileManager.ts");
function activate(context) {
    console.log('Congratulations, your extension "pyinit" is now active!');
    let disposable = vscode.commands.registerCommand('extension.generateInit', (fileObj) => __awaiter(this, void 0, void 0, function* () {
        fileObj = yield fileManager.getValidResource(fileObj);
        if (!!fileObj) {
...
function generateInits(dirList) {
    let counter = 0;
...
exports.generateInits = generateInits;
